...
class HydraSource {
  constructor ({ regl, width, height, pb, label = "", prevTime = 0}) {
    this.label = label
    this.regl = regl
    this.src = null
    this.dynamic = true
  ...
  initVideo (url = '', start = 0) {
    ...
    console.log("created video", vid)
    console.log("this.prevTime:")
    console.log(this.prevTime)
    const onload = vid.addEventListener('loadeddata', () => {
      this.src = vid
      vid.currentTime = this.prevTime
      vid.play()
      console.log("video currentTime", vid.currentTime)
      this.tex = this.regl.texture(this.src)
      this.dynamic = true
    })
    vid.src = url
  ...
  tick (time) {
    ...
    if (this.src !== null && this.dynamic === true) {
      console.log("ticking video")
      this.prevTime = this.src.currentTime
